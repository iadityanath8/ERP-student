...
import { 
  ...
  ChevronDown, User, LogOut, GraduationCap, Award,
  ClipboardList, BarChart3, MessageSquare, UserCircle,
} from 'lucide-react';

type UserRole = 'admin' | 'franchise' | 'student' | 'teacher' | 'parent';
                    ...
                    {notifications.map((notification) => (
                      <div
                        ...
                        className={`px-4 py-3 hover:bg-gray-50 cursor-pointer border-l-4 ${
                          notification.unread ? 'bg-blue-50 border-indigo-500' : 'border-transparent'
                        }`}
                      >
            ...
            {navigationItems.map((item) => {
              ...
              return (
                <button
                  ...
                  className={`flex items-center space-x-2 px-4 py-3 text-sm font-medium rounded-t-lg transition-all ${
                    isActive
