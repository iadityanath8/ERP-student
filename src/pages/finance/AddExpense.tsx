...
const AddExpense: React.FC = () => {
  ...
  const [formData, setFormData] = useState<Omit<ExpenseEntry, 'id' | 'createdAt'>>({
    expenseHeadId: '',
    expenseHeadName: '',
    amount: 0,
  ...
  const handleSubmit = (e: React.FormEvent) => {
    e.preventDefault();
    console.log('Creating expense entry:', formData);
    navigate('/admin/finance/expense');
  };
      ...
      <div className="max-w-4xl mx-auto">
        <div className="bg-white rounded-xl shadow-md p-6">
          <div className="flex items-center gap-4 mb-6">
            <button
              onClick={() => navigate('/admin/finance/expense')}
              ...
              <div>
                ...
                <select
                  ...
                  onChange={(e) => {
                    ...
                    setFormData({ ...formData, expenseHeadId: e.target.value, expenseHeadName: selected.text });
                  }}
                  required
                ...
                >
                  ...
                  <option value="4">Other Expenses</option>
                </select>
              </div>
