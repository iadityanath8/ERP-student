...
import { ArrowLeft, Upload, FileImage, FileText, CheckCircle2, X } from 'lucide-react';
import { useNavigate, useParams } from 'react-router-dom';

const UploadAdmissionDocuments: React.FC = () => {
  ...
  const handleFileChange = (type: 'photo' | 'idProof' | 'signature' | 'marksheet', file: File | null) => {
        ...
        <div className="bg-white rounded-xl shadow-md p-6">
          ...
          <div className="grid md:grid-cols-2 gap-6">
            ...
            <div className="border-2 border-dashed border-gray-300 rounded-lg p-8 text-center hover:border-indigo-400 transition">
              ...
              <h3 className="text-lg font-semibold text-gray-900 mb-2">Student Photo</h3>
              <input
                type="file"
                accept="image/*"
            ...
            <div className="border-2 border-dashed border-gray-300 rounded-lg p-8 text-center hover:border-indigo-400 transition">
              <FileText className="mx-auto text-gray-400 mb-4" size={48} />
              <h3 className="text-lg font-semibold text-gray-900 mb-2">Marksheet</h3>
              <input
                type="file"
                accept="image/*,.pdf"
              ...
              >
                <Upload size={20} />
                {documents.marksheet ? 'Change Marksheet' : 'Upload Marksheet'}
              </label>
              {documents.marksheet && (
                <div className="mt-4 flex items-center justify-center gap-2 text-green-600">
                  <CheckCircle2 size={20} />
                  <span className="text-sm font-medium">{documents.marksheet.name}</span>
                </div>
              )}
            </div>
          </div>
...
export default UploadAdmissionDocuments;
